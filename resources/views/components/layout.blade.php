              ...
              <div class="ml-4 flex items-center md:ml-6">
                ...
                @auth
                  <form method="POST" action="/logout">
                    @csrf
                    <x-button2 type="submit">Logout</x-button> 
                  </form>
        ...
        <div class="md:hidden" id="mobile-menu">
          ...
          <div class="border-t border-gray-700 pb-3 pt-4">
            <div class="flex items-center px-5">
              ...
              <div class="ml-3">
                <div class="text-base font-medium leading-none text-white">Clive Corner</div>
                <div class="text-sm font-medium leading-none text-gray-400">clivecorner@btinternet.com</div>
              </div>
